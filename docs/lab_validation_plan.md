...
- scenario definitions under `lab/scenarios/`
- prepared-environment profiles under `lab/config/`
- result bundles under `lab/results/`
- consolidated indexes under:
  - `lab/reports/lab_execution_index.json`
  - `lab/reports/lab_execution_index.md`
  - `lab/reports/prepared_env_validation_index.json`
