...
The detailed boundary is documented in [supported_operating_profile.md](docs/supported_operating_profile.md).
...
This baseline is preserved as the project reference point. It should be read together with the fresh-output replay rule and the SQLite append caveat already documented in [README.md](README.md).

## Comparative Baseline Study

A reproducible comparison run is now available at:

- [comparison_baseline.json](docs/generated/comparison_baseline.json)
- [comparison_baseline.md](docs/generated/comparison_baseline.md)
...
- the earlier `8`-alert mismatch has been reconciled in [hybrid_tuned_reconciliation.md](docs/generated/hybrid_tuned_reconciliation.md)
...
These metrics are currently category/label-based replay-review metrics, not event-aligned scientific benchmark metrics. The methodology and limits are documented in [metrics_methodology.md](docs/metrics_methodology.md).
...
Validation breadth has been formalized in [validation_breadth.md](docs/validation_breadth.md). The project now clearly separates:
...
- [performance_profile.md](docs/performance_profile.md)
- [performance_profile.json](docs/generated/performance_profile.json)
...
Failure behavior is formalized in [failure_mode_matrix.md](docs/failure_mode_matrix.md). That matrix covers:
...
This split is formalized in [supported_operating_profile.md](docs/supported_operating_profile.md):
