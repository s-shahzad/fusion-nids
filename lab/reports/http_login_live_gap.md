...
- Offline replay pass:
  - [serious_test_report.md](<workspace>\lab/results/http-login-bruteforce-smoke/serious_test_report.md)
- Resolved live VM pass:
  - [serious_test_report.md](<workspace>\lab/results/live-http-login-bruteforce-port80-20260310-224500/serious_test_report.md)
