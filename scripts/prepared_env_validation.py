...
def _scenario_paths(scenario: dict[str, Any]) -> tuple[str, str, str, Path]:
    ...
    result_rel = posixpath.join("lab", "results", run_name.replace("\\", "/"))
